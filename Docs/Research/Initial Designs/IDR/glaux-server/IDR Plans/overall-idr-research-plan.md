...
| B | IDR-SRV-006 to IDR-SRV-014, IDR-SRV-010A, IDR-SRV-014A to IDR-SRV-014H | Complete (18/18) | 18/18 | 17/18 | Research In Review | 2026-08-31 | IDR-SRV-006 through IDR-SRV-014G reports are complete and accepted; IDR-SRV-014H research is complete and its report is in review; the shared upstream-history register remains Version 1.9 because no tracked Part 3 state changed during execution; IDR-SRV-015 remains unstarted. |
