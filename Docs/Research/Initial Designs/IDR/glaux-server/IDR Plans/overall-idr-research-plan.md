...
| B | IDR-SRV-006 to IDR-SRV-014, IDR-SRV-010A, IDR-SRV-014A to IDR-SRV-014G | Complete (17/17) | 6/17 | 5/17 | Research In Progress | 2026-08-01 | IDR-SRV-006 through IDR-SRV-010 reports are complete and accepted; IDR-SRV-010A research is complete and its report is in review with plan-owner acceptance pending; the shared upstream-history register is refreshed to Version 1.4; later topics remain unstarted. |
