...
| F | IDR-SRV-031 to IDR-SRV-038 | Complete (8/8) | 7/8 | 6/8 | Research In Review | 2026-09-15 | IDR-SRV-031 through IDR-SRV-036 are complete and accepted; IDR-SRV-037 is complete and in review; IDR-SRV-038 is not authorized. The shared upstream-history register remains Version 1.12 after the tasking-issue date check. |
