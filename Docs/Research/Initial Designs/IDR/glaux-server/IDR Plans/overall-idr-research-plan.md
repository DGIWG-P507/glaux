...
| F | IDR-SRV-031 to IDR-SRV-038 | Complete (8/8) | 6/8 | 6/8 | Research In Progress | 2026-09-15 | IDR-SRV-031 through IDR-SRV-036 are complete and accepted; IDR-SRV-037 is authorized as the next bounded single-topic iteration. The shared upstream-history register is Version 1.12. |
