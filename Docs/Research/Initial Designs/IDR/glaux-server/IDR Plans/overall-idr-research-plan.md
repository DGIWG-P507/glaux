...
| F | IDR-SRV-031 to IDR-SRV-038 | Complete (8/8) | 1/8 | 1/8 | Research In Progress | 2026-09-14 | IDR-SRV-031 is complete and accepted; IDR-SRV-032 is authorized as the next bounded single-topic iteration. The shared upstream-history register is Version 1.11. |
