...
| G | IDR-SRV-039, IDR-SRV-039A, IDR-SRV-040 to IDR-SRV-043 | Complete (6/6) | 4/6 | 4/6 | Research In Progress | 2026-09-15 | IDR-SRV-039 through IDR-SRV-041 are complete and accepted. IDR-SRV-042 is authorized as the next bounded single-topic iteration; IDR-SRV-043 and later topics remain unauthorized. The shared upstream-history register remains Version 1.12. |
