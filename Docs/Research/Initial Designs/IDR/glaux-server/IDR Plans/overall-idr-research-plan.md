...
| F | IDR-SRV-031 to IDR-SRV-038 | Complete (8/8) | 4/8 | 4/8 | Research In Progress | 2026-09-15 | IDR-SRV-031 through IDR-SRV-034 are complete and accepted; IDR-SRV-035 is authorized as the next bounded single-topic iteration. The shared upstream-history register is Version 1.11. |
