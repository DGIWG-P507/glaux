...
**Checkpoint:** September 19, 2026, through Copilot Pass 3c iteration 15 (F-13 controlling extension-rule check resolved: no published rule governs extra members in Observation JSON; the inbound policy is a project choice to record, and unknown-member rejection is not prescribed).
