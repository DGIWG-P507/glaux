...
**Checkpoint:** September 19, 2026, through Pass 3c iteration 16 (provider handoff to Claude Code after a GitHub Copilot subscription-budget stop; bookkeeping correction for issues #98/#99/#130; research-deep-read-remainders slice 1 closed: IDR-008 Sections 16-19, IDR-037 Appendices A-D, IDR-038 Appendices A-C, and IDR-039 Section 7 and Sections 21-22 fully read and accounted against Guide v1.3, adding related instances under F-03, F-19 and F-20).
...
| Research | Synthesis/register read; full reads of 008, 011, 029, 031, 036, 037, 038, 039, 041, 050, 052; other partial reads | Corpus-wide key-section sweep and several previously promised deep reads |
...
Research portions: IDR-008 sections 16-19, IDR-037 appendices A-D, IDR-038 appendices A-C, and IDR-039 section 7 and sections 21-22 were closed as slice 1 of the deep-read remainders in iteration 16 (all four reports are now fully read). Remaining: IDR-040 sections 9-21 (next selected slice); remaining 042/043 sections. Additional promised deep reads were 030, 034, 039A and 055. Some CS-GO/OSH pinned-source spot checks remain unaccounted for.
...
**Research deep-read remainders, slice 1 (iteration 16):** IDR-008 Sections 16-19, IDR-037 Appendices A-D, IDR-038 Appendices A-C, and IDR-039 Section 7 and Sections 21-22 were read in full and accounted against Guide v1.3. No Guide correction and no new finding number resulted; three related instances were recorded above (F-03, F-19, F-20) and one new follow-up question was recorded (`fq-09`, metrics/traces exposure). All four reports move from partial to fully read. Evidence: [21-pass-3c-16-research-deep-read-slice1.md](evidence/21-pass-3c-16-research-deep-read-slice1.md). Remaining research deep-read scope: IDR-040 Sections 9-21 (next selected slice), remaining IDR-042/043 sections, and the committed deep reads IDR-030, IDR-034, IDR-039A and IDR-055, none yet begun.
