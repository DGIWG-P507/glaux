...
**Status: all six approved bounded updates are delivered. Guide v1.8 and the five restore-issue amendments now include the post-backup-deletion clarification. Software implementation remains pending; other actions remain proposed.**
...
Sources: [final assessment and controlling Erratum A](evidence/51-pass-3c-45-final-consolidated-assessment.md#erratum-a---two-statements-corrected), [findings](findings.md), and [saved questions](review-state.json), at [review-close commit abf2efa](https://github.com/DGIWG-P507/glaux/tree/abf2efad7761d44f63c2f7d4c68f8ff023027ab1/Docs/Plans/glaux-server/Review). Reviewed baseline: Goal v1.8, Guide v1.3, Roadmap v1.18. Current approved follow-up: Guide v1.8 / Roadmap v1.23, with Goal v1.8 unchanged. Every issue number below belongs to [glaux-server](https://github.com/DGIWG-P507/glaux-server/issues).
...
**Decision record:** licence remains unselected; enforcement changes remain unauthorised. All six bounded updates are approved and delivered; the sixth adopts only F-19's separate restore/deletion clarification. This does not convert the remaining recommendations into requirements.
...
**Current handoff:** the restore/deletion update is delivered; stop here. Recommended next bounded iteration: F-11, the exact link-relation spellings clients will receive. Reuse the recorded source-conflict evidence, check the specific published provisions, state the selected per-relation rule in the existing Guide and propagate it to #56/#212/#214/#228. Do not assume the bare, private-URN and full-OGC-URI forms are interchangeable or need one universal spelling. Stop at those instructions and matching fixture expectations; no broad research or new compatibility subsystem. This next proposal awaits the lead's `proceed`. Licence/enforcement decisions remain outstanding. No implementation issue is complete. The closed `review-state.json` remains review coverage, not an implementation queue.
